  ...
  return (
    <section className="bg-[#f9fdfc] py-12 px-4 sm:px-6 lg:px-8 font-sans pb-24">
      <div className="max-w-5xl mx-auto bg-white rounded-[2.5rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-50 px-6 py-16 md:py-20 text-center">
        ...
        {/* Search Form */}
        <form className="max-w-3xl mx-auto relative mb-8 flex flex-col sm:flex-row gap-4 sm:gap-0" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 text-[14px] text-slate-500 font-medium">
          ...
          <button className="hover:text-teal-600 transition-colors">Emergency Vet</button>
          <button className="hover:text-teal-600 transition-colors">Cat Food</button>
          <button className="hover:text-teal-600 transition-colors">Adoption Events</button>
          <button className="hover:text-teal-600 transition-colors">Dog Training</button>
        </div>
