        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div className="flex flex-col gap-4 pr-4">
            <div className="flex items-center gap-3 text-white mb-2">
              ...
              <span className="text-lg font-bold tracking-wide">Animal Welfare</span>
            </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[15px]">
              ...
              <li><a href="/adoption" className="hover:text-teal-600 transition-colors duration-200">Adoption Centers</a></li>
        ...
        <div className="flex justify-center items-center text-[15px]">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-12">
            ...
            <span className="flex items-center gap-2">
              Animal Welfare Platform. Made with <FaHeart className="text-slate-400 text-sm mx-1" /> for animals.
            </span>
          </div>
        </div>
